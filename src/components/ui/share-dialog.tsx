...
import { CheckIcon, CopyIcon, ExternalLink, Link as LinkIcon, Share2, XIcon } from "lucide-react";
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Udostępnij stronę</DialogTitle>
          <p className="text-sm text-muted-foreground">
            Udostępnij link do Engleo znajomym.
          </p>
        </DialogHeader>
        <div className="space-y-4 py-4">
          ...
          <div className="flex space-x-2">
            ...
            <Button variant="outline" className="flex-1 gap-2" onClick={() => window.open('https://engleo.pl', '_blank')}>
